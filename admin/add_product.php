...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($error)) {
        $sql = "INSERT INTO products (name, description, price, stock, category_id, image, sizes) VALUES (?, ?, ?, ?, ?, ?, ?)";
        if($stmt = mysqli_prepare($conn, $sql)) {
            mysqli_stmt_bind_param($stmt, "ssdiiss", $name, $description, $price, $stock, $category_id, $image, $sizes);
...
<head>
    ...
    <title>Add Product - Aling Hera's Embroidery</title>
                ...
                <?php if(!empty($success)): ?>
                    <div class="alert alert-success">
                        ...
                        <div class="mt-2">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary" onclick="document.getElementById('addProductForm').reset();">
                                        ...
                                        <div id="imagePreview" class="mt-2" style="display: none;">
                                            <div class="card">
                                                <div class="card-body p-2 text-center">
                                                    ...
                                                    <p class="mt-2 mb-0 small text-muted">Image Preview</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
